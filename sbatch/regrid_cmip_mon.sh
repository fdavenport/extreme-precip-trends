#!/bin/bash
#SBATCH --job-name=rg_cmip_mon
#SBATCH --error=/davenport-scratch/fvdav22/job_output/regrid_cmip_mon_%a.err
#SBATCH --output=/davenport-scratch/fvdav22/job_output/regrid_cmip_mon_%a.out
...
histpath="/davenport-scratch/DATA/CMIP6/raw_data/historical/mon/pr"
...
python -u ./regrid_cmip.py --freq="mon" --var="pr" --model=$modelname
