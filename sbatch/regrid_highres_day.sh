#!/bin/bash
#SBATCH --job-name=rg_highres_day
#SBATCH --error=/davenport-scratch/fvdav22/job_output/regrid_highres_day_%a.err
#SBATCH --output=/davenport-scratch/fvdav22/job_output/regrid_highres_day_%a.out
...
histpath="/davenport-scratch/DATA/CMIP6/raw_data/hist-1950/day/pr"
...
python -u ./regrid_highres_cmip.py --freq="day" --var="pr" --model=$modelname --overwrite
