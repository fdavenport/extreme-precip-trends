#!/bin/bash
#SBATCH --job-name=cmip_trends
#SBATCH --error=/davenport-scratch/fvdav22/job_output/calc_cmip_trends.err
#SBATCH --output=/davenport-scratch/fvdav22/job_output/calc_cmip_trends.out
...
for start_year in {1930..1975..5}; do
    ...
    python -u ./calc_cmip_trends.py --start=$start_year --end=$((start_year + 41)) --q=0.95 --freq="mon" --res="cmip"
    python -u ./calc_cmip_stats.py --start=$start_year --end=$((start_year + 41)) --freq="mon" --res="cmip"

    # calculate trends through end date
    python -u ./calc_cmip_trends.py --start=$start_year --end=2020 --q=0.95 --freq="mon" --res="cmip"
    python -u ./calc_cmip_stats.py --start=$start_year --end=2020 --freq="mon" --res="cmip"
